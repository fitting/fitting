...
public class ContainerFixture extends FittingFixture {
    ...
    public String windowTitle() throws FittingException {
        final ElementContainer activeContainer = getElementContainerProvider().getActiveElementContainer();
     ...
     */
    public void navigateTo(final String uri) throws FittingException {
     ...
     */
    public void resizeToBy(final String width, final String height) throws FittingException {
        Dimension size;
        try {
     ...
     */
    public boolean containerContainsText(final String text) throws FittingException {
     ...
     */
    public boolean waitSecondsForElementWithBeing(final int seconds, final String selector, final String identifier) {
        boolean present;
        try {
     ...
     * @return <code>true</code> if the element was found within the timeout time, <code>false</code> if not.
     */
    public boolean waitSecondsForElementWithBeingAndContaining(final int seconds, final String selector, final String identifier, final String contents) {
        boolean present;
        try {
