...
public interface Element extends SearchContext {
     ...
     */
    void sendKeys(final CharSequence... characters);
     ...
     * @see Element#isInput()
     */
    void setValue(final String value) throws FittingException;
     ...
     * @see Element#isInput()
     */
    void setValueWithText(final String text) throws FittingException;
