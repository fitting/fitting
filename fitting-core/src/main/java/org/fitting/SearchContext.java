...
public interface SearchContext {
     ...
     */
    List<Element> findElementsBy(final Selector selector) throws FittingException;
     ...
     * @throws FittingException When the query failed to execute.
     */
    Element findElementBy(final Selector selector) throws NoSuchElementException, FittingException;
     ...
     */
    void waitForElement(final Selector selector, final int timeout) throws NoSuchElementException;
     ...
     * @throws NoSuchElementException When no element was found within the provided time-out.
     */
    void waitForElementWithContent(final Selector selector, final String content, final int timeout);
}
