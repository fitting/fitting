...
/** {@link org.fitting.ElementContainerProvider} Selenium implementation for browser windows. */
public class SeleniumWindowProvider extends ElementContainerProvider {
     ...
     */
    public SeleniumWindowProvider(BrowserConnector browser) {
        this.driver = browser.getWebDriver();
        manageElementContainer(browser.getWindow(), true);
    }
